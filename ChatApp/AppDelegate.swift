...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var stateLogger = StateLogger(initialState: "Not running", instanceName: "Application")
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        stateLogger.logState(stateName: "Background")
    }
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        stateLogger.logState(stateName: "Active")
    }
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        ...
        self.saveContext()
        stateLogger.logState(stateName: "Suspended")
    }
